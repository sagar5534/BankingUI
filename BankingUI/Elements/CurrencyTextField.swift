...
public struct CurrencyTextField: UIViewRepresentable {
    ...
    public func makeCoordinator() -> CurrencyTextField.Coordinator {
        Coordinator(value: $value, isResponder: isResponder, onReturn: onReturn) { flag in
    ...
    public func updateUIView(_ textField: UITextField, context: UIViewRepresentableContext<CurrencyTextField>) {
        ...
        if value != context.coordinator.internalValue {
            if value == nil {
                ...
                textField.text = Formatter.currency.string(from: NSNumber(value: value!))
            }
        }
    ...
    public static func dismantleUIView(_: UITextField, coordinator _: CurrencyTextField.Coordinator) {
        // nothing to cleanup
    }
